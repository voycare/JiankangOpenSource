  ...
  export default {
    ...
    methods: {
      getMessages(page) {
        ...
        rf.getRequest('ClinicRequest').getMessages(params).then((res) => {
      ...
      onMarkReads() {
        ...
        rf.getRequest('ClinicRequest').postMessageMarkRead(params).then((res) => {
          self.getMessages()
        });
      },
      ...
      onMarkUnreads() {
        ...
        rf.getRequest('ClinicRequest').postMessageMarkUnread(params).then((res) => {
          self.getMessages()
        });
      },
    }
