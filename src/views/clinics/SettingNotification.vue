    ...
    <div class="row">
      ...
      <div class="col-sm-8">
        ...
        <ul class="list-group notification-list">
          ...
          <li class="list-group-item justify-content-between notification-title"
              v-if="appHelper.isAdmin() || appHelper.isClinic()">
            Reviews
            <div class="material-switch float-right">
              <input
                  @change="onChangeNotification"
          ...
          <li class="list-group-item justify-content-between notification-title" v-if="appHelper.isClinic()">
            Statements
            <div class="material-switch float-right">
              <input
                  @change="onChangeNotification"
                  ...
                  type="checkbox"
                  v-model="statements">
              <label class="badge-primary" for="sw_statements"></label>
            </div>
          </li>
