  ...
  <div>
    <div class="row">
      ...
      <div class="col-sm-4 text-right">
        <a class="btn btn-pink btn-rounded" href="appointment/add">Add Appointment</a>
      </div>
    </div>
    <div class="row">
      <div class="col-sm-12">
        ...
        <div class="table-responsive table table-bordered table-striped">
          <table class="table mb-0">
            ...
            <tr :key="appointment.id" v-for="appointment in appointments">
              ...
              <td>{{Utils.intToDate(appointment.date, "YYYY-MM-DD hh:mm A" )}}</td>
...
<script>
  ...
  export default {
    ...
    methods: {
      getAppointment() {
        fetch(API.getApi(API.CLIENT.APPOINTMENT.LIST), {
          method: 'get',
          headers: {
